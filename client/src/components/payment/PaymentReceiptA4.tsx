...
const PaymentReceiptA4 = forwardRef<HTMLDivElement, PaymentReceiptA4Props>(
  ({ payment, customer, balance, allocations, company }, ref) => {
    if (!payment) {
      return (
      ...
      <div className="receipt-a4" ref={ref}>
        ...
        <div className="r4-info-section">
          <div className="r4-bill-to">
            <h3 className="r4-section-label">Received From</h3>
          ...
          <table className="r4-balance-table">
            <tbody>
              ...
              <tr className="r4-balance-payment-row">
                <td className="r4-balance-label">Payment Received</td>
        ...
        {allocations.length > 0 && (
          <div className="r4-allocations-section">
            <h3 className="r4-section-label">Allocated Invoices</h3>
        ...
        <div className="r4-footer">
          <p className="r4-footer-thanks">Thank you for your payment!</p>
          {company?.email && (
