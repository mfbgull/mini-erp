...
// Static pages array - defined outside component to avoid recreation on every render
const PAGES: Page[] = [
  ...
  { name: 'Suppliers', path: '/suppliers', category: 'Purchasing' },
  { name: 'Bill of Materials', path: '/bom', category: 'Manufacturing' },
  { name: 'Production', path: '/production', category: 'Manufacturing' },
  { name: 'Sales', path: '/sales', category: 'Sales' },
  { name: 'Point of Sale', path: '/pos', category: 'Sales' },
  { name: 'Quotations', path: '/quotations', category: 'Sales' },
  { name: 'Sales Orders', path: '/sales-orders', category: 'Sales' },
  { name: 'Invoice Returns', path: '/sales/returns', category: 'Sales' },
  { name: 'Customers', path: '/customers', category: 'Sales' },
  { name: 'Payments', path: '/payments', category: 'Sales' },
  ...
  { name: 'Expenses', path: '/expenses', category: 'Reports' },
  ...
  { name: 'Employees', path: '/employees', category: 'HR' },
  { name: 'Activity Log', path: '/activity-log', category: 'General' },
  { name: 'Integrations', path: '/integrations', category: 'General' },
  { name: 'Ecosystem', path: '/ecosystem', category: 'General' },
...
const SearchModal = memo(function SearchModal({ isOpen, onClose }: SearchModalProps) {
  ...
  // Memoized filtered pages - only recalculate when searchTerm changes
  ...
  // Memoized grouped pages - only recalculate when filteredPages changes
  const groupedPages = useMemo(() =>
    filteredPages.reduce((acc: Record<string, Page[]>, page) => {
