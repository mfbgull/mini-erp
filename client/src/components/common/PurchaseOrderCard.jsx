  ...
  return (
    <>
      <div
        ...
        role="button"
        tabIndex={0}
        aria-label={`Purchase Order: ${po.po_no}`}
        onKeyDown={(e) => {
              ...
              <div className="menu-dropdown" role="menu">
                ...
                {canSubmit && (
                  <button
                    type="button"
                    className="menu-item"
                    onClick={(e) => handleStatusUpdate('Submitted', e)}
                    role="menuitem"
                    disabled={isLoading}
                  >
                    <FileCheck size={16} />
          ...
          >
            <div className="po-modal-header">
              <div className="po-modal-title-section">
                <h2 id="po-modal-title" className="po-modal-title">
                  {po.po_no}
                </h2>
                <span className={`po-modal-status ${getStatusClass(po.status)}`}>
                  {po.status}
                </span>
              </div>
              <button
            ...
            <div className="po-modal-content">
              ...
              {po.notes && (
                <section className="po-section">
                  <h3 className="po-section-title">Notes</h3>
                  <p className="po-notes">{po.notes}</p>
                </section>
              )}
              ...
              {(po.created_at || po.updated_at) && (
                <section className="po-section po-section-meta">
                  <div className="po-meta-grid">
                    ...
                    {po.updated_at && (
                      <div className="po-meta-item">
                        <span className="po-meta-label">Last Updated</span>
                        <span className="po-meta-value">
            ...
            <div className="po-modal-actions">
              <button
                type="button"
                className="po-action-btn po-action-secondary"
                onClick={() => setShowDetails(false)}
              >
                Close
              </button>
              {canSubmit && (
                <button
                  type="button"
                  className="po-action-btn po-action-success"
                  onClick={(e) => {
                    handleStatusUpdate('Submitted', e);
                    setShowDetails(false);
                  }}
                  disabled={isLoading}
                >
