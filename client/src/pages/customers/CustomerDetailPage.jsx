...
function OverviewTab({ customer, invoices, ledger, payments }) {
  ...
  return (
    <div className="overview-tab">
      {/* Financial Summary Section - Always visible on mobile */}
      ...
      <div className="overview-card collapsible-section">
        ...
        >
          ...
          <span className="expand-icon">{expandedSections.contactInfo ? '−' : '+'}</span>
        </div>
      ...
      <div className="overview-card collapsible-section">
        ...
        >
          ...
          <span className="expand-icon">{expandedSections.accountSettings ? '−' : '+'}</span>
        </div>
      ...
      {/* Collapsible Recent Invoices Section */}
      <div className="overview-card collapsible-section">
        <div
          className="section-header"
          onClick={() => toggleSection('recentInvoices')}
          style={{ cursor: 'pointer', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}
        >
          <h4 className="subsection-title">Latest Invoices</h4>
          <span className="expand-icon">{expandedSections.recentInvoices ? '−' : '+'}</span>
        </div>

        {expandedSections.recentInvoices && (
          <div className="section-content">
      ...
      {/* Collapsible Recent Payments Section */}
      <div className="overview-card collapsible-section">
        <div
          className="section-header"
        ...
        >
          ...
          <span className="expand-icon">{expandedSections.recentPayments ? '−' : '+'}</span>
        </div>
